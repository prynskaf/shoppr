...
const OrderPage =  async() => {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen bg-gray-50 p4'>
                ...
                >
                    <div className="p-4 sm:p-6 border-b border-gray-200">
                        <div className="flex flex-col gap-4 sm:flex-row  sm:justify-between sm:items-center mb-4">
                            <div>
                                <p className='text-gray-900  mb-1 font-bold text-sm'>Order Number:</p>
                                <p className='font-mono text-green-600 text-sm'>{order.orderNumber}</p>
                            </div>
                    ...
                    <div className='flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center'>
                        ...
                        <div className="sm:text-right">
                            ...
                            <p className="font-bold text-lg"> {formatCurrency(order.totalPrice ?? 0, order.currency)}</p>
                        </div>
                    </div>
                            ...
                            >
                                <div className="flex items-center gap-3 sm:gap-4">
                                    {product.product?.image && (
                                        <div className="relative h-14 w-14 sm:w-16  flex-shrink-0 rounded-md overflow-hidden">
                                            <Image 
