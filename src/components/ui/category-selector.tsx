...
export const CategorySelectorComponent = ({ categories }: CategorySelectorProps) => {
        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button
                    ...
                    role='combobox'
                    aria-expanded={open}
                    className='w-full max-w-full relative flex justify-center mt-4 sm:justify-start sm:flex-none items-center 
